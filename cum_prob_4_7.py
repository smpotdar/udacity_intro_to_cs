# -*- coding: utf-8 -*-
"""
Created on Sun Jul 10 11:30:38 2016
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 10 10:22:34 2016
...
def remove_tags(text):
    ...
    if(text.find('<')+1==0):
        ...
        if(start==0):
            return remove_tags(text[end+1:])
        elif(end==len(text)-1):
            return remove_tags(text[0:start])
        else:
            return remove_tags(text[0:start]+' '+text[end+1:])
