# -*- coding: utf-8 -*-
"""
Created on Sun Jul 10 12:43:29 2016
...
def date_converter(dict1,date1):
    #fs1=date1.find('/')
    #fs2=date1.find('/',fs1+1)
    month,day,year=date1.split('/')
    #return date1[fs1+1:fs2]+' '+dict1[int(date1[:fs1])]+' '+date1[fs2+1:]
    return day+' '+dict1[int(month)]+' '+year
